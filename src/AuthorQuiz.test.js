...
const state = {
  turnData: {
    ...
    author: {
      ...
      imageURL:
        "https://upload.wikimedia.org/wikipedia/commons/5/56/Charles_Dickens_by_Herbert_Watkins_29_April_1858_%28alternate%29.jpg",
...
describe("Author Quiz", () => {
  ...
  describe("When no answer has been selected", () => {
    ...
    it("should have no background color", () => {
      const bgColor = wrapper.find("div.row.turn").props().style.backgroundColor;
      expect(bgColor).toBe("");
    });
  });
  ...
  describe("When the first answer is selected", () => {
    ...
    beforeAll(() => {
      wrapper = Enzyme.mount(<AuthorQuiz {...state} onAnswerSelected={handleAnswerSelected} />);
      wrapper
        .find(".answer")
        .first()
        .simulate("click");
